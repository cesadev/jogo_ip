...
class CenaMatinta(CenaBase):
    def __init__(self, tela, imagens_cartas, deck_jogador_global, proxima_depois="mapa"):
        ...
        # Todas as opções de diálogos dinâmicos
        opcoes_dialogos = [
            [
                "Matinta - Olá novamente viajante...",
                "Matinta - Tô vendo que esses seus bichanos ainda estão bem fraquinhos...",
            ...
            [
                "Matinta - Ei, viajante... Você novamente...",
                "Matinta - Pelo visto os seus bichinhos continuam fracos",
                "Matinta - Já repensou sobre colocar umas asinhas neles?",
                "Matinta - Você quem sabe...",
                "Tu se sente obrigado a fazer um sacrifício marcante, um que não tem volta..."
            ],
            [
                "Matinta - Viajante! Aí está você...",
                "Matinta - Ainda continua com os bichos fraquinhos?",
                "Matinta - O que acha de adicionar umas asas novas neles?",
                "Matinta - A decisão é sua...",
                "Tu se sente obrigado a fazer um sacrifício marcante, um que não tem volta..."
            ],
            [
                "Matinta - Amigo viajante...",
                "Matinta - Os seus animais não me parecem muito fortes...",
                "Matinta - Já imaginou neles com asas nas costas?",
                "Matinta - Você pode mudar isso...",
                "Tu se sente obrigado a fazer um sacrifício marcante, um que não tem volta..."
            ]
        ]
        
        #sorteia aleatoriamente o dialogo atual
        self.textos_dialogo = random.choice(opcoes_dialogos)
    ...
    def desenhar(self):
        ...
        #o limite da quantia de dialogos n precisa ser exato, mas como nós fizemos todos com uma quantia só, acho melhor que a gente deixe assim estático, deixar dinamico daria umt rabalho chato
        if self.estado != "dialogo":
